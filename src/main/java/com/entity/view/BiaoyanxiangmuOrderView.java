...
public class BiaoyanxiangmuOrderView extends BiaoyanxiangmuOrderEntity implements Serializable {
	...
	public BiaoyanxiangmuOrderView() {

	}

	public BiaoyanxiangmuOrderView(BiaoyanxiangmuOrderEntity biaoyanxiangmuOrderEntity) {
		try {
			BeanUtils.copyProperties(this, biaoyanxiangmuOrderEntity);

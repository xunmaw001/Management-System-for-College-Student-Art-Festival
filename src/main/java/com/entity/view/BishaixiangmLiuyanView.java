...
public class BishaixiangmLiuyanView extends BishaixiangmLiuyanEntity implements Serializable {
	...
	public BishaixiangmLiuyanView() {

	}

	public BishaixiangmLiuyanView(BishaixiangmLiuyanEntity bishaixiangmLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, bishaixiangmLiuyanEntity);

 ...
 * @date 2021-04-26
 */
@TableName("bishaixiangm_order")
public class BishaixiangmOrderView extends BishaixiangmOrderEntity implements Serializable {
	...
	public BishaixiangmOrderView() {

	}

	public BishaixiangmOrderView(BishaixiangmOrderEntity bishaixiangmOrderEntity) {
		try {
			BeanUtils.copyProperties(this, bishaixiangmOrderEntity);

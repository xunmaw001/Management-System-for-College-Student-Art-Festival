...
public class BiaoyanxiangmuLiuyanView extends BiaoyanxiangmuLiuyanEntity implements Serializable {
	...
	public BiaoyanxiangmuLiuyanView() {

	}

	public BiaoyanxiangmuLiuyanView(BiaoyanxiangmuLiuyanEntity biaoyanxiangmuLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, biaoyanxiangmuLiuyanEntity);

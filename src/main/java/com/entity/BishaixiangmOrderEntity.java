...
public class BishaixiangmOrderEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public BishaixiangmOrderEntity() {

	}

	public BishaixiangmOrderEntity(T t) {
		try {

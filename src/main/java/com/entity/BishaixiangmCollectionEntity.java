...
public class BishaixiangmCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public BishaixiangmCollectionEntity() {

	}

	public BishaixiangmCollectionEntity(T t) {
		try {

            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">表演项目留言展示</span>
...
<script>
    var vue = new Vue({
        ...
        data: {
            ...
            dataList: [],//数据
        // 当前表字典表数据
            biaoyanxiangmuLiuyanTypes: 1,//类型
            limit: 10,
        ...
        filters: {
            //把 biaoyanxiangmuLiuyanContent 字段去除无用字符 如果字段长度大于60  就截取到60
            biaoyanxiangmuLiuyanContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            // 当前表
                                                                    // 获取列表数据
            http.request('biaoyanxiangmuLiuyan/list', 'get', param, function(res) {

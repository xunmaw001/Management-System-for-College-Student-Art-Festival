                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="jieqianxinxiName" id="jieqianxinxiName" placeholder="标题" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../jieqianxinxi/detail.jsp?id='+item.id)">
                                    <a href="#" class="ng-prsliik">
                                        <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img class="swiper-item" :src="item.jieqianxinxiPhoto?item.jieqianxinxiPhoto.split(',')[0]:''" />
                                        </span>
                                ...
                                <div class="ng-prslist-tit" @click="jump('../jieqianxinxi/detail.jsp?id='+item.id)"><span>{{item.jieqianxinxiName}}</span></div>
                                <div class="ng-prslist-tit" v-if="item.jieqianxinxiNewMoney"><span style="color: red;">{{item.jieqianxinxiNewMoney}} RMB</span></div>
                            </div>
                        </li>
                    </ul>
                </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 jieqianxinxiContent 字段去除无用字符 如果字段长度大于60  就截取到60
            jieqianxinxiContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#jieqianxinxiName').val() != null && jquery('#jieqianxinxiName').val() != "" && jquery('#jieqianxinxiName').val() != "null" ) {
                param['jieqianxinxiName'] = jquery('#jieqianxinxiName').val();
            }
                                            // 获取列表数据
            http.request('jieqianxinxi/list', 'get', param, function(res) {

              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">比赛结束时间:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="bishaijieguoTime" id="bishaijieguoTime"  placeholder="比赛结束时间"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">比赛结果:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="biaoyanxiangmuBisaijieguo" id="biaoyanxiangmuBisaijieguo"  placeholder="比赛结果"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>

	...
	<body style="background: #EEEEEE;">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="bishaijieguoTime" id="bishaijieguoTime"  lay-verify="required|date"   placeholder="比赛结束时间" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="biaoyanxiangmuBisaijieguo" id="biaoyanxiangmuBisaijieguo" lay-verify="required" placeholder="比赛结果" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`bishaijieguo/session`, 'get', {}, function (data) {
                    // 表单赋值

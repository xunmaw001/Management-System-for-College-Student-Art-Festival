	...
	<body style="background: #EEEEEE;">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="bishaixiangmName" id="bishaixiangmName" lay-verify="required" placeholder="比赛项目" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="bishaixiangmTypes" id="bishaixiangmTypes">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="bishaixiangmNumber" id="bishaixiangmNumber"  lay-verify="required|integer"   placeholder="报名人数" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="bishaixiangmTime" id="bishaixiangmTime"  lay-verify="required|date"   placeholder="结束报名时间" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="bishaixiangmPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="bishaixiangmPhoto" name="bishaixiangmPhoto"/>
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`bishaixiangm/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#bishaixiangmPhotoImg").attr("src", data.data.bishaixiangmPhoto);
                });

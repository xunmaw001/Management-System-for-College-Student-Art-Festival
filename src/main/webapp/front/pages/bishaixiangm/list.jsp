                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../bishaixiangm/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../bishaixiangm/detail.jsp?id='+item.id)"><span>{{item.bishaixiangmName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 bishaixiangmContent 字段去除无用字符 如果字段长度大于60  就截取到60
            bishaixiangmContent: function(val) {
                if (val) {
        ...
        function pageList() {
            ...
            if (bishaixiangmTypes != null && bishaixiangmTypes != "" && bishaixiangmTypes != "null") {
                param['bishaixiangmTypes'] = bishaixiangmTypes;
                                                            ...
                                                            // 获取列表数据
            http.request('bishaixiangm/list', 'get', param, function(res) {

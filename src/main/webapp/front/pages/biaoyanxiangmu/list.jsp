                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../biaoyanxiangmu/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../biaoyanxiangmu/detail.jsp?id='+item.id)"><span>{{item.biaoyanxiangmuName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 biaoyanxiangmuContent 字段去除无用字符 如果字段长度大于60  就截取到60
            biaoyanxiangmuContent: function(val) {
                if (val) {
        ...
        function pageList() {
            ...
            if (biaoyanxiangmuTypes != null && biaoyanxiangmuTypes != "" && biaoyanxiangmuTypes != "null") {
                param['biaoyanxiangmuTypes'] = biaoyanxiangmuTypes;
                                                            ...
                                                            // 获取列表数据
            http.request('biaoyanxiangmu/list', 'get', param, function(res) {

...
var centerMenu = [
    ...
    ,{
        name: '表演项目收藏',
        url: '../biaoyanxiangmuCollection/list.jsp'
    }
    ,{
        name: '表演项目报名记录',
        url: '../biaoyanxiangmuOrder/list.jsp'
    }
    ,{
        name: '比赛项目收藏',
        url: '../bishaixiangmCollection/list.jsp'
    }
    ,{
        name: '比赛项目报名记录',
        url: '../bishaixiangmOrder/list.jsp'
    }
]
...
var indexNav = [
    ...
    {
        name: '表演项目',
        url: './pages/biaoyanxiangmu/list.jsp'
    },
    {
        name: '比赛项目',
        url: './pages/bishaixiangm/list.jsp'
    },
    {
        name: '节前信息',
        url: './pages/jieqianxinxi/list.jsp'
    },
    {
        name: '公告',
...
var adminurl =  "http://localhost:8080/daxueshengyishujie/index.jsp";
